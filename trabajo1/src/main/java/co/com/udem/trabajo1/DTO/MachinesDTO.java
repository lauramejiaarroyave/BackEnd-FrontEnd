package co.com.udem.trabajo1.DTO;
...
public class MachinesDTO {
	...
	public double saveMachine;
	public double finalPriceMachine;
	

	public MachinesDTO(int id, String imageMachine, String nameMachine,
			Double priceMachine, Double discountMachine,
			String descriptionMachine, String availabilityMachine,
			double saveMachine, double finalPriceMachine) {
		super();
		this.id = id;
		...
		this.finalPriceMachine = finalPriceMachine;
	}
	...
	public Double getSaveMachine() {
		return saveMachine;
	}
	public void setSaveMachine(Double saveMachine) {
		this.saveMachine = saveMachine;
	}
	public double getFinalPriceMachine() {
		return finalPriceMachine;
	}
	public void setFinalPriceMachine(double finalPriceMachine) {
		this.finalPriceMachine = finalPriceMachine;
	}
